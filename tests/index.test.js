...
const autocomplete = { field: 'skill', text: 'c++', size: 10 };
...
describe('Person Enrichment', () => {
  it(`Should Return Person Record for ${phone}`, () => {
...
describe('Person Bulk', () => {
  it(`Should Return Person Records for ${JSON.stringify(records)}`, () => {
...
describe('Person Search', () => {
  it(`Should Return Person Records for ${personSQL}`, () => {
  ...
  it(`Should Return Person Records for ${JSON.stringify(personElastic)}`, () => {
...
describe('Person Retrieve', () => {
  it(`Should Return Person Record for ${personID}`, () => {
...
describe('Company Enrichment', () => {
  it(`Should Return Company Record for ${website}`, () => {
...
describe('Company Search', () => {
  it(`Should Return Company Records for ${companySQL}`, () => {
  ...
  it(`Should Return Company Records for ${JSON.stringify(companyElastic)}`, () => {
...
describe('Autocomplete', () => {
  it(`Should Return Autocomplete Records for ${JSON.stringify(autocomplete)}`, () => {
...
describe('Cleaner APIs', () => {
  it(`Should Return Company Cleaner Records for ${JSON.stringify(company)}`, () => {
  ...
  it(`Should Return Location Cleaner Records for ${JSON.stringify(location)}`, () => {
  ...
  it(`Should Return School Cleaner Records for ${JSON.stringify(school)}`, () => {
